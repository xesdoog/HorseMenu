...
namespace Lua::native
{
	...
	static bool LUA_NATIVE_LOCALIZATION_DOES_CURRENT_LANGUAGE_SUPPORT_CONDENSED_STYLE_()
	{
		auto retval = (bool)LOCALIZATION::_DOES_CURRENT_LANGUAGE_SUPPORT_CONDENSED_STYLE();
		return retval;
	}
	...
	void init_native_binding_LOCALIZATION(sol::state& L)
	{
		...
		LOCALIZATION.set_function("DOES_CURRENT_LANGUAGE_SUPPORT_CONDENSED_STYLE_", LUA_NATIVE_LOCALIZATION_DOES_CURRENT_LANGUAGE_SUPPORT_CONDENSED_STYLE_);
